...
ActiveRecord::Schema.define(version: 20160121035105) do
  ...
  add_index "reviews", ["voiture_id"], name: "index_reviews_on_voiture_id", using: :btree
  ...
  add_foreign_key "reviews", "voitures"
